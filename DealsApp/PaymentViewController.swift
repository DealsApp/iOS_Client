...
//  DealsApp
//
//  Created by Chen, David on 10/2/16.
...
//    postTransactionToServer(nonce, amount, userid, item_id….) when have time implement this multiple parameters send to Server.
    
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if (segue.identifier == "showPaymentSuccessViewController") {
            if (success) {
                guard segue.destinationViewController is PaymentSuccessViewController else {
